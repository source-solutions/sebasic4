...
#define SE_GRAVEAC (SE_SYMBOL<<8) | SE_X
...
#define SE_BREAK   (SE_SHIFT<<8) | SE_SPACE
#define SE_EDIT    (SE_SHIFT<<8) | SE_1
#define SE_CPSLOCK (SE_SHIFT<<8) | SE_2
#define SE_TRUE    (SE_SHIFT<<8) | SE_3
#define SE_INVERSE (SE_SHIFT<<8) | SE_4
#define SE_LEFT    (SE_SHIFT<<8) | SE_5
#define SE_DOWN    (SE_SHIFT<<8) | SE_6
#define SE_UP      (SE_SHIFT<<8) | SE_7
#define SE_RIGHT   (SE_SHIFT<<8) | SE_8
#define SE_GRAPH   (SE_SHIFT<<8) | SE_9
#define SE_DELETE  (SE_SHIFT<<8) | SE_0
#define SE_EXTEND  (SE_SHIFT<<8) | SE_SYMBOL
...
#define SE_COMPOSE	(SE_SHIFT<<8) | SE_ENTER
...
// Scan code 2 list. ISO 102 key layout
...
int main()
{
    ...
    MAPANY(PC_LCTRL,SE_GRAPH,0,0);   // MD2 is CTRL
    MAPANY(PC_RCTRL,SE_GRAPH,0,0); // MD2 is CTRL
    MAPANY(PC_LALT,SE_EXTEND,0,0);    // MD3 is ALT. Also is FIRE for keyboard joystick
    MAPANY(PC_RALT,SE_EXTEND,0,0);    // MD3 is ALT. Also is FIRE for keyboard joystick
    
    MAPANY(PC_LWIN,SE_SYMBOL,0,0);          // SYMBOL SHIFT
    MAPANY(PC_RWIN,SE_SYMBOL,0,0);          // SYMBOL SHIFT  
	MAPANY(PC_APPS,SE_COMPOSE,0,0);          //    
    ...
    MAP(PC_GRAVEAC,SE_GRAVEAC,0,0);
    MAP(MD1|PC_GRAVEAC,SE_TILDE,0,0);

    // a letter key with shift (MD1) is like pressing CAPS SHIFT + letter
    MAP(MD1|PC_Q,SE_SHIFT<<8|SE_Q,0,0);
    MAP(MD1|PC_W,SE_SHIFT<<8|SE_W,0,0);
    MAP(MD1|PC_E,SE_SHIFT<<8|SE_E,0,0);
    MAP(MD1|PC_R,SE_SHIFT<<8|SE_R,0,0);
    MAP(MD1|PC_T,SE_SHIFT<<8|SE_T,0,0);
    MAP(MD1|PC_Y,SE_SHIFT<<8|SE_Y,0,0);
    MAP(MD1|PC_U,SE_SHIFT<<8|SE_U,0,0);
    MAP(MD1|PC_I,SE_SHIFT<<8|SE_I,0,0);
    MAP(MD1|PC_O,SE_SHIFT<<8|SE_O,0,0);
    MAP(MD1|PC_P,SE_SHIFT<<8|SE_P,0,0);
    MAP(MD1|PC_A,SE_SHIFT<<8|SE_A,0,0);
    MAP(MD1|PC_S,SE_SHIFT<<8|SE_S,0,0);
    MAP(MD1|PC_D,SE_SHIFT<<8|SE_D,0,0);
    MAP(MD1|PC_F,SE_SHIFT<<8|SE_F,0,0);
    MAP(MD1|PC_G,SE_SHIFT<<8|SE_G,0,0);
    MAP(MD1|PC_H,SE_SHIFT<<8|SE_H,0,0);
    MAP(MD1|PC_J,SE_SHIFT<<8|SE_J,0,0);
    MAP(MD1|PC_K,SE_SHIFT<<8|SE_K,0,0);
    MAP(MD1|PC_L,SE_SHIFT<<8|SE_L,0,0);
    MAP(MD1|PC_Z,SE_SHIFT<<8|SE_Z,0,0);
    MAP(MD1|PC_X,SE_SHIFT<<8|SE_X,0,0);
    MAP(MD1|PC_C,SE_SHIFT<<8|SE_C,0,0);
    MAP(MD1|PC_V,SE_SHIFT<<8|SE_V,0,0);
    MAP(MD1|PC_B,SE_SHIFT<<8|SE_B,0,0);
    MAP(MD1|PC_N,SE_SHIFT<<8|SE_N,0,0);
    MAP(MD1|PC_M,SE_SHIFT<<8|SE_M,0,0);

    MAPANY(PC_SPACE,SE_SPACE,0,0);
    MAPANY(PC_ENTER,SE_ENTER,0,0);

    //Complex mapping. This is for the US keyboard although many
    //combos can be used with any other PC keyboard
    MAPANY(PC_ESC,SE_BREAK,0,0);
    MAPANY(PC_TAB,SE_EDIT,0,0);
    MAPANY(PC_CPSLOCK,SE_CPSLOCK,0,0);
    MAP(PC_BKSPACE,SE_DELETE,0,0);
    ...
    MAPANY(PC_KP_MULT,SE_STAR,0,0);
    MAPANY(PC_KP_MINUS,SE_MINUS,0,0);
    MAPANY(PC_KP_PLUS,SE_PLUS,0,0);
    MAPANY(PC_KP_ENTER,SE_ENTER,0,0); 
    ...
    MAP(MD1|PC_2,SE_AT,0,0);
    MAP(MD1|PC_3,SE_HASH,0,0);
    MAP(MD1|PC_4,SE_DOLLAR,0,0);
    MAP(MD1|PC_5,SE_PERCEN,0,0);
    MAP(MD1|PC_6,SE_CARET,0,0);
    MAP(MD1|PC_7,SE_AMP,0,0);
    MAP(MD1|PC_8,SE_STAR,0,0);
    MAP(MD1|PC_9,SE_PAROPEN,0,0);
    MAP(MD1|PC_0,SE_PARCLOS,0,0);
    MAP(PC_MINUS,SE_MINUS,0,0);
    MAP(MD1|PC_MINUS,SE_UNDERSC,0,0);
    MAP(PC_EQUAL,SE_EQUAL,0,0);
    MAP(MD1|PC_EQUAL,SE_PLUS,0,0);
    MAP(PC_BRAOPEN,SE_BRAOPEN,0,0);
    MAP(MD1|PC_BRAOPEN,SE_CUROPEN,0,0);
    MAP(PC_BRACLOS,SE_BRACLOS,0,0);
    MAP(MD1|PC_BRACLOS,SE_CURCLOS,0,0);
    MAP(PC_BACKSLA,SE_BACKSLA,0,0);
    MAP(MD1|PC_BACKSLA,SE_PIPE,0,0);
    MAP(PC_APOSTRO,SE_APOSTRO,0,0);
    MAP(MD1|PC_APOSTRO,SE_QUOTE,0,0);
    MAP(PC_COMMA,SE_COMMA,0,0);
    MAP(MD1|PC_COMMA,SE_LESS,0,0);
    MAP(PC_DOT,SE_DOT,0,0);
    MAP(MD1|PC_DOT,SE_GREATER,0,0);
    MAP(PC_SLASH,SE_SLASH,0,0);
    MAP(MD1|PC_SLASH,SE_QUEST,0,0);
    MAP(PC_SEMICOL,SE_SEMICOL,0,0);
    MAP(MD1|PC_SEMICOL,SE_COLON,0,0);

// editing cluster
	MAP(PC_INSERT,SE_INSERT,0,0);
	MAP(MD1|PC_INSERT,SE_HELP,0,0);
	MAPANY(PC_DELETE,SE_DEL,0,0);
	MAP(PC_HOME,SE_HOME,0,0);
	MAP(MD1|PC_HOME,SE_CLR,0,0);
	MAPANY(PC_END,SE_END,0,0);
	MAPANY(PC_PGUP,SE_TRUE,0,0);
	MAPANY(PC_PGDOWN,SE_INVERSE,0,0);
