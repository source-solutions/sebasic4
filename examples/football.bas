...
Var q2: Num = 2
Var pl: Num = 9
Var f: NumArray(3, 2) = 25, 20, 15, 10, 19, 8
Var g: NumArray(3, 2) = 14, 11, 15, 9, 14, 10
Var d: NumArray(4) = 32, 13, 2, 0
Var k: NumArray(3) = 10, 13, 1
Var s: NumArray(2) = 2, 2
Var a: NumArray(5) = 12, 10, 18, 7, 5
Var u: NumArray(5) = 13, 2, 3, 5, 15
Var z: NumArray(17) = 1, 3, 1, 0, 0, 3, 1, 0, 1, 1, 3, 0, 3, 3, 0, 1, -1
Var b: NumArray(16) = 2, 3, 2, 1, 0, 3, 2, 0, 2, 2, 3, 1, 1, 3, 1, 2
Var c: NumArray(16) = 2, 1, 2, 3, 1, 1, 2, 3, 2, 2, 0, 3, 0, 1, 3, 2
Var p: NumArray(24) = 2, 2, 2, 2, 2, 0, 2, 0, 0, 0, 2, 0, 0, 0, 1, 2, 2, 0, 2, 0, 0, 0, 2, 0
Var t: NumArray(16) = 11, 3, 8, 15, 12, 2, 7, 16, 10, 9, 1, 14, 5, 4, 13, 6
Var x: NumArray(2) = 64, 49
Var y: NumArray(24) = 16, 13, 14, 16, 7, 15, 12, 6, 16, 12, 13, 20, 7, 15, 8, 8, 9, 12, 10, 2, 5, 18, 16, 4
Var r: NumArray(24) = 3, 3, 5, 1, 1, 1, 5, 5, 1, 1, 3, 4, 4, 2, 3, 4, 2, 5, 2, 4, 4, 3, 1, 4
Var v: NumArray(24) = 15000, 15000, 25000, 5000, 5000, 5000, 25000, 25000, 5000, 5000, 15000, 20000, 20000, 10000, 15000, 20000, 10000, 25000, 10000, 20000, 20000, 15000, 5000, 20000
Var i: NumFOR = 101200, 24, 1, 8022, 2
Var q: NumFOR = 99, 2, 1, 1172, 2
Var r: NumFOR = 6, 8, 1, 293, 2
Var o: NumFOR = 6, 5, 1, 5002, 2
Var j: NumFOR = 4, 3, 1, 342, 5
Var e: NumFOR = 6, 5, 1, 341, 2
Var m$: Str = "Dunny"
Var y$: Str = ""
Var i$: Str = "99"
Var x$: Str = "keep"
Var d$: StrArray(1) = "\f"
Var k$: StrArray(2) = "\l\h"
Var f$: StrArray(8) = "\a\b\c\d\e\n\l\h"
Var u$: StrArray(16) = "\#011\#006\#002\#014\#013\#003\#010\#009\#001\#005\#015\#012\#004\#008"
Var l$: StrArray(7, 16) = "Beginner        Novice          Average         Good            Expert          Super Expert    Genius          "
Var r$: StrArray(3, 2) = "D\::M\::A\::"
Var p$: StrArray(24, 8) = "P.ParkesD.WatsonP.Neal  A.MartinK.SansomM.Mills R.Osman S.FosterB.RobsonG.HoddleG.Rix   S.Hunt  G.Owen  R.Moses B.TalbotS.McCallC.Regis P.Withe T.MorleyP.BarnesE.Gates K.ReevesK.KeeganG.Shaw  "
Var t$: StrArray(64, 12) = "York City Aston V.  Brighton  Coventry  Everton   Ipswich   Liverpool Luton     Man.City  Man.Utd   Norwich   Notts.F.  Swansea   Spurs     Watford   West Ham  Blackburn Bolton    Cambridge Charlton  Chelsea   Crystal P.Derby CoFulham    Grimsby   Leeds     MiddlesbroNewcastle Oldham    Q.P.R.    Rotherham Sheff.Wed Bradford  Brentford Bristol R.Cardiff   Doncaster Exeter    Lincoln   Millwall  Newport   Orient    Oxford    Plymouth  Preston   Reading   Southend  Walsall   Blackpool Bury      ColchesterCrewe     DarlingtonHalifax   HartlepoolHereford  Hull      Mansfield Port Vale Rochdale  ScunthorpeStockport Torquay   Arsenal   "
Var a$: StrArray(7, 9) = "Energy   Morale   Defence  Midfield Attack   Division Lge.Pos. "
Var q$: StrArray(3, 5) = " pi"
...
# End Run-time Variables
 ...
 810 GO TO 100
1000 PRINT ,,"You've \`";m;" You owe \`";l''
1002 RETURN
1010 CLS :\
     PRINT ' BRIGHT 1; INVERSE 1;"You haven't enough money!"
1015 RETURN
1020 PRINT ,,a$(7);t(t1-lt);TAB 13;"League match no.=";ml
1022 RETURN
1030 GO SUB 1180:\
     BEEP .2,0:\
...
1043 RETURN
1050 CLS
1052 PRINT "p = picked to play, i = injured"
1053 RETURN
1080 PRINT BRIGHT 1; INK 0; PAPER 6;"OR type 99 to continue":\
     BEEP .2,0
1084 RETURN
...
1189 RETURN
2000 CLS
2020 PRINT "TO -","TYPE -",,,"Sell or list",," your Players","  - a",,,"Print score etc","  - s",,,"Obtain a loan","  - l",,,"Pay off loan","  - p"''"Change your"'"   skill level","  - level"''"Change team or"'"  player names","  - change",,,"Save game","  - keep",,,
2040 GO SUB 1080
2180 GO SUB 1180:\
     INPUT LINE x$
...
2481 PRINT "He is injured- nobody wants him!"
2482 GO SUB 1030
2483 GO TO 2539
2484 LET o=INT (((RND *5+8)*v(i))/10)
2485 PRINT t$(FN r(64));" have offered \`";o," for ";p$(i)''"He is worth \`";v(i):\
     GO SUB 1180:\
     INPUT "Do you accept?", LINE i$
...
2536 LET p(i)=3
2539 RETURN
2540 PRINT BRIGHT 1; PAPER 6;"  NAME   NO. SKILL ENERGY VALUE"
2545 RETURN
...
2800 CLS
2802 GO SUB 1000
2804 PRINT '"Type loan amount required (\`)"
2805 GO SUB 1170
2806 LET i=q
2807 CLS
2820 IF i+l>250000*d2 THEN PRINT "Sorry, your credit limit is-",,"\` ";250000*d2:\
     GO SUB 1030:\
     GO TO 2800
2830 LET m=m+i:\
     LET l=l+i
...
2900 CLS :\
     GO SUB 1000
2905 PRINT '"Type amount you want to pay off your loan (\`)"
2910 GO SUB 1170
2915 LET i=q
2917 CLS
2920 IF i>l THEN PRINT "YOU DON'T OWE THAT MUCH!":\
     GO SUB 1030:\
     GO TO 2900
...
3010 PRINT '"Managerial Rating(Max 100)= ";s1
3012 PRINT '"Level ";l1, BRIGHT 1; INK l1; PAPER 9;l$(l1); BRIGHT 0;" "''"Seasons ";s5
3016 GO SUB 1000
3020 PRINT a$(2);a(2)
3030 GO SUB 1020
3032 GO SUB 1030
3040 RETURN
3200 CLS
3205 PRINT "Your present skill level is -"'"Level ";l1, BRIGHT 1; INK l1; PAPER 9;l$(l1):\
...
3250 LET l1=q:\
     CLS :\
     PRINT "Your new skill level is -"'"Level ";l1, BRIGHT 1; INK l1; PAPER 9;l$(l1):\
     GO SUB 1030
3260 RETURN
4000 LET ma=ma+1
4001 LET lc=2
...
5204 IF s(h)<s(v) THEN LET fa=1:\
     PRINT "+++You're out of the Cup+++":\
     LET a(2)=INT (a(2)/2):\
     GO TO 5230
5210 IF c<8 THEN PRINT "****You are through to the next",,"round!****      "
5212 IF c<>8 THEN GO TO 5220
5213 PRINT BRIGHT 1; INK 1; PAPER 6;'"                                                                                                                                                                                                                                                                                                                                "
5214 PRINT FLASH 1; BRIGHT 1;"!!!!!!!!!You've won the !!!!!!!!!!!!!!!!!  F.A. CUP     !!!!!!!!"
5216 FOR i=1 TO 9:\
     PRINT FLASH 1; BRIGHT 1;"********************************":\
     BEEP .2,i:\
     NEXT i
5218 LET fa=1
...
6113 GO SUB 6500
6115 GO SUB 1120
6120 PRINT "Type c to change team"
6130 GO SUB 1080
6135 GO SUB 1180:\
     INPUT LINE i$:\
...
6210 PRINT "Type Player No. to add to team"
6215 GO SUB 1080
6216 GO SUB 1170
6217 LET i=q
6218 IF i=99 THEN GO TO 6112
6220 IF i<1 OR i>24 THEN PRINT "PLAYER NO. OUT OF RANGE":\
     GO TO 6216
6225 IF p(i)<>1 THEN PRINT "PLAYER NOT AVAILABLE":\
     GO TO 6216
6230 LET p(i)=2
6240 GO TO 6142
6300 PRINT "Type player no. to remove from"'"team"
6310  GO SUB 1170
6312 LET i=q
6320 IF i<1 OR i>24 THEN PRINT "PLAYER NO. OUT OF RANGE":\
     GO TO 6310
6325 IF p(i)<>2 THEN PRINT "PLAYER NOT IN TEAM":\
     GO TO 6310
6330 LET p(i)=1
6340 GO TO 6142
6499 RETURN
...
8027 NEXT i
8032 PRINT "****WEEKLY BILLS****"''"Wage Bill = \`";w'"Ground rent = \`";x'"Loan Interest = \`";INT (l/100)
8036  LET m=m-w-x-INT (l/100)
8040 LET i=m-l-xp:\
     PRINT "Weekly Balance = "; INK 0+(i<0)*2;"\`";i
8045 LET xp=m-l
8050 IF m>=0 THEN GO TO 8060
8051 LET l=l-m
8052 LET m=0
8056 PRINT "LOAN INCREASED TO PAY BILLS"
8060 IF l>250000*d2 THEN PRINT "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++YOU OWE OVER \`";250000*D2'"++++YOU'VE BEEN SACKED BY THE +++++++++++++++++++++++++++CLUB!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++":\
     GO SUB 1030:\
     NEW
8070 GO SUB 1030
8099 RETURN
...
8222 PRINT "League Success Bonus Money =",,"        \`";r1*5000*d2
8230 LET s5=s5+1
8235 FOR i=1 TO 16
8240 GO SUB 8500
8243 GO SUB 8600
...
8705 CLS
8710 PRINT "****Transfer Market****"''
8711 IF p1>15 THEN PRINT "You cannot buy a player because you have 16 in your squad - thatis the maximum allowed under    F.A. rules.":\
     GO TO 8778
8715 GO SUB 1000
8720 GO SUB 2540
8725 LET pl=r1
8730 GO SUB 2550
8740 PRINT '"Type your bid (\`)"''
8742 GO SUB 1080
8745 GO SUB 1170
8746 LET n=q
...
8786 PRINT '"YOUR BID IS REFUSED"
8788 RETURN
...
8910 CLS
8912 PRINT BRIGHT 1;"CHOOSE TEAM TO MANAGE -"
8915 PRINT "NUMBER","NAME"
8916 LET lt=(d1-1)*16
...
8957 FOR i=1 TO 7:\
     ...
     NEXT i
8960 PRINT "Type your level (1-7)"
8962 GO SUB 1170
8963 LET l1=q
...
9210 READ t$(i)
9220 NEXT i
9230 DATA "Arsenal","Aston V.","Brighton","Coventry","Everton","Ipswich","Liverpool","Luton","Man.City","Man.Utd","Norwich","Notts.F.","Swansea","Spurs","Watford","West Ham"
9240 DATA "Blackburn","Bolton","Cambridge","Charlton","Chelsea","Crystal P.","Derby Co.","Fulham","Grimsby","Leeds","Middlesbro","Newcastle","Oldham","Q.P.R.","Rotherham","Sheff.Wed"
9250 DATA "Bradford","Brentford","Bristol R.","Cardiff","Doncaster","Exeter","Lincoln","Millwall","Newport","Orient","Oxford","Plymouth","Preston","Reading","Southend","Walsall"
9260 DATA "Blackpool","Bury","Colchester","Crewe","Darlington","Halifax","Hartlepool","Hereford","Hull","Mansfield","Port Vale","Rochdale","Scunthorpe","Stockport","Torquay","York City"
9270 LET q$(1)=" "
9271 LET q$(2)="p"
9272 LET q$(3)="i"
9273 LET r$(1)="D\::"
...
9299 RETURN
9400 CLS
9405 INPUT "Do you want to change any team  names (y/n)?", LINE i$
9410  IF i$<>"y" AND i$<>"Y" AND i$<>"yes" AND i$<>"YES" THEN GO TO 9499
9415 LET d3=0
9420 LET d3=d3+1
9425 IF d3>4 THEN GO TO 9415
9430 CLS :\
     PRINT a$(6);d3
9435 PRINT "NUMBER","NAME":\
     LET low=(d3-1)*16
9440 FOR i=low+1 TO low+16:\
     PRINT i,t$(i):\
     NEXT i
9445 PRINT "Type no. of team to be changed  OR 99 for more choice           "
9450 GO SUB 1170:\
     IF q=99 THEN GO TO 9420
9455 IF q<low+1 OR q>low+16 THEN PRINT "TEAM NUMBER OUT OF RANGE":\
     GO TO 9450
9460 LET i=q:\
     PRINT "Present team is ";t$(i)
9465 INPUT "Type new team name", LINE i$
9466 IF i$="h" OR i$="H" THEN COPY :\
     GO TO 9465
9467 IF LEN i$=0 THEN GO TO 9465
9471 IF CODE i$(1)<>16 THEN GO TO 9476
9472 IF CODE i$(2)<0 OR CODE i$(2)>4 THEN PRINT "INVALID COLOUR":\
     GO TO 9465
9473 IF CODE i$(3)<65 OR CODE i$(3)>122 THEN PRINT "INVALID TEAM NAME":\
     GO TO 9465
9474 IF LEN i$>12 THEN PRINT "TEAM NAME TOO LONG- max 10 chars":\
     GO TO 9465
9475 GO TO 9478
9476 IF CODE i$(1)<65 OR CODE i$(1)>122 THEN PRINT "INVALID TEAM NAME":\
     GO TO 9465
9477 IF LEN i$>10 THEN PRINT "TEAM NAME TOO LONG- max 10 chars":\
     GO TO 9465
9478 LET t$(i)=i$:\
     PRINT "New team name ";t$(i)
9479 INPUT "Any more changes (y/n)?", LINE i$:\
     IF i$="h" OR i$="H" THEN COPY :\
     GO TO 9479
9480  IF i$="y" OR i$="Y" OR i$="yes" OR i$="YES" THEN GO TO 9430
9499 RETURN
9500 CLS
9505 INPUT "Do you want to change any playernames (y/n)?", LINE i$
9510  IF i$<>"y" AND i$<>"Y" AND i$<>"yes" AND i$<>"YES" THEN GO TO 9599
9515 LET d3=0
9516 LET d3=d3+1
9520 IF d3>3 THEN GO TO 9515
9525 CLS :\
     PRINT a$(d3+2)
9530 PRINT "NUMBER","NAME":\
     LET low=(d3-1)*8
...
9550 IF q<low+1 OR q>low+8 THEN PRINT "PLAYER NO. OUT OF RANGE":\
     GO TO 9545
9555 LET i=q:\
     PRINT "Present player is ";p$(i)
9560 INPUT "Type new player name", LINE i$:\
     IF i$="h" OR i$="H" THEN COPY :\
     GO TO 9560
9561 IF LEN i$=0 THEN GO TO 9560
9565 IF CODE i$(1)<65 OR CODE i$(1)>122 THEN PRINT "INVALID PLAYER NAME":\
     GO TO 9560
9570 IF LEN i$>8 THEN PRINT "PLAYER NAME TOO LONG-max 8 chars":\
     GO TO 9560
9575 LET p$(i)=i$:\
     PRINT "New player name ";p$(i)
9580 INPUT "Any more changes (y/n)?"; LINE i$:\
     IF i$="h" OR i$="H" THEN COPY :\
     GO TO 9580
9585  IF i$="y" OR i$="Y" OR i$="yes" OR i$="YES" THEN GO TO 9525
9599 RETURN
