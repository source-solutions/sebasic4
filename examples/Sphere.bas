Auto 1
 ...
 290 LET by=c1*c3-s1*s2*s3:\
     LET bz=-s1*c2
 300 LET cx=s1*s3-c1*s2*c3
 310 LET cy=s1*c3+c1*s2*s3:\
     LET cz=c1*c2
 400 REM draw outer
 410 CLS :\
     CIRCLE u,v,r
 ...
 530 GO SUB 1000:\
     REM xx,yy,zz calc
 540 IF yy>0 THEN LET f2=0:\
     LET f1=0:\
     GO TO 580
 550 LET xb=INT (u+xx+h):\
     LET yb=INT (v+zz+h):\
     LET f2=1
 560 IF f1=0 THEN LET x1=xb:\
     LET y1=yb:\
     LET f1=1:\
     GO TO 580
 570 PLOT x1,y1:\
 ...
 630 GO SUB 1000:\
     REM xx,yy,zz
 640 IF yy>0 THEN LET f2=0:\
     LET f1=0:\
     GO TO 680
 650 LET xb=INT (u+xx+h):\
     LET yb=INT (v+zz+h):\
     LET f2=1
 660 IF f1=0 THEN LET x1=xb:\
     LET y1=yb:\
     LET f1=1:\
     GO TO 680
 670 PLOT x1,y1:\
