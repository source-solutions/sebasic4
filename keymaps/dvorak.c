/*
SE Basic IV 4.3 Drusilla - A classic BASIC interpreter for the Z80 architecture.
...
int main()
{
    ...
    MAP(PC_MINUS,SE_BRAOPEN);
    MAP(MD_SHIFT|PC_MINUS,SE_CUROPEN);
    MAP(PC_EQUAL,SE_BRACLOS);
    MAP(MD_SHIFT|PC_EQUAL,SE_CURCLOS);

	// row 2
    MAP(PC_Q,SE_APOSTRO);
    MAP(MD_SHIFT|PC_Q,SE_QUOTE);
    MAP(PC_W,SE_COMMA);
    MAP(MD_SHIFT|PC_W,SE_LESS);
    MAP(PC_E,SE_DOT);
    MAP(MD_SHIFT|PC_E,SE_GREATER);
    MAP(PC_R,SE_P);
    MAP(PC_T,SE_Y);
    MAP(PC_Y,SE_F);
    MAP(PC_U,SE_G);
    ...
    MAP(MD_SHIFT|PC_T,SE_CAPS<<8|SE_Y);
    MAP(MD_SHIFT|PC_Y,SE_CAPS<<8|SE_F);
    MAP(MD_SHIFT|PC_U,SE_CAPS<<8|SE_G);
    MAP(MD_SHIFT|PC_I,SE_CAPS<<8|SE_C);
    MAP(MD_SHIFT|PC_O,SE_CAPS<<8|SE_R);
    MAP(MD_SHIFT|PC_P,SE_CAPS<<8|SE_L);
    MAP(PC_BRAOPEN,SE_SLASH);
    MAP(MD_SHIFT|PC_BRAOPEN,SE_QUEST);
    MAP(PC_BRACLOS,SE_EQUAL);
    MAP(MD_SHIFT|PC_BRACLOS,SE_PLUS);
    ...
    MAP(MD_SHIFT|PC_S,SE_CAPS<<8|SE_O);
    MAP(MD_SHIFT|PC_D,SE_CAPS<<8|SE_E);
    MAP(MD_SHIFT|PC_F,SE_CAPS<<8|SE_U);
    MAP(MD_SHIFT|PC_G,SE_CAPS<<8|SE_I);
    MAP(MD_SHIFT|PC_H,SE_CAPS<<8|SE_D);
    MAP(MD_SHIFT|PC_J,SE_CAPS<<8|SE_H);
    MAP(MD_SHIFT|PC_K,SE_CAPS<<8|SE_T);
    MAP(MD_SHIFT|PC_L,SE_CAPS<<8|SE_N);
    MAP(MD_SHIFT|PC_SEMICOL,SE_CAPS<<8|SE_S);
    MAP(PC_APOSTRO,SE_MINUS);
    MAP(MD_SHIFT|PC_APOSTRO,SE_UNDERSC);

	// row 4
    MAP(PC_Z,SE_SEMICOL);
    MAP(MD_SHIFT|PC_Z,SE_COLON);
    ...
    MAP(PC_DOT,SE_V);
    MAP(PC_SLASH,SE_Z);
    MAP(MD_SHIFT|PC_X,SE_CAPS<<8|SE_Q);
    MAP(MD_SHIFT|PC_C,SE_CAPS<<8|SE_J);
    MAP(MD_SHIFT|PC_V,SE_CAPS<<8|SE_K);
    MAP(MD_SHIFT|PC_B,SE_CAPS<<8|SE_X);
    MAP(MD_SHIFT|PC_N,SE_CAPS<<8|SE_B);
    MAP(MD_SHIFT|PC_M,SE_CAPS<<8|SE_M);
    MAP(MD_SHIFT|PC_COMMA,SE_CAPS<<8|SE_W);
    MAP(MD_SHIFT|PC_DOT,SE_CAPS<<8|SE_V);
    MAP(MD_SHIFT|PC_SLASH,SE_CAPS<<8|SE_Z);
    ...
    SAVEMAPBIN("../chloehd/SYSTEM/KEYBOARD.S/DVORAK.KB");
