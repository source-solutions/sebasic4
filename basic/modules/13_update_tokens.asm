...
;	// TO-DO: SOUND and GRAPHICS commands to be made external.
;	// These are hardware dependent and externalizing them should aid portability.
...
;	// exceptional functions (no arguments, and so on)
	...
	tk_erl			equ $80
	str "ERL";		line number of last error
	tk_err			equ $81
	str "ERR";		error code of last error
	tk_pi			equ $82;
	str "PI";		3.14159265358979
	tk_pos			equ $83;
	str "POS";		cursor position in line
	tk_time			equ $84;
	str "TIME";		current QNX time

;	// file functios (single argument)
	tk_eof			equ $85;
	str "EOF #";
	tk_loc			equ $86;
	str "LOC #";
...
;	// commands
	...
	str "CALL";
	tk_chain		equ $be;
	str "CHAIN";	load and run another program while keeping variables
	tk_chdir		equ $bf;
	str "CHDIR";
	tk_clear		equ $c0;
	str "CLEAR";
